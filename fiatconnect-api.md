...
Otherwise, if `keyType` is `RANDOM`, `key` MUST be a string of 32 alphanumeric characters. (In this last case, the key represents a random key generated by the user's bank.) 
