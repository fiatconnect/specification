...
For `GH` the list of supported mobile provider codes is as mentioned below - 
...
For `GH` the list of supported bank codes is as mentioned below - 
...
For `KE` the list of supported mobile provider codes is as mentioned below - 
...
For `RW` the list of supported mobile provider codes is as mentioned below -
...
For `CM` and `CG` the list of supported mobile provider codes is as mentioned below -
...
For `ZA` the list of bank codes is as mentioned below -
